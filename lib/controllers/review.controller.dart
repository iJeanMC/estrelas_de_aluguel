...
class ReviewController {
  Future<Database> getDatabase() async {
    ...
    Database database = await openDatabase(path, version: 1,
      ...
      await db.execute(
          'CREATE TABLE review (id INTEGER PRIMARY KEY autoincrement, stars REAL, text_box TEXT, title TEXT, autor_id INTEGER, FOREIGN KEY (autor_id) REFERENCES user(id), worker_reviewed INTEGER, FOREIGN KEY (worker_reviewed) REFERENCES worker(id))');
    });
    return database;
  }
